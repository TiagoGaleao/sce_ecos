...
all: pic_control cmd monitor comando reg_buf
...
comando: comando.o reg_buf.o
	$(XLD) $(LDFLAGS) $(ECOS_GLOBAL_LDFLAGS) -o $@ $@.o reg_buf.o
...
pic_control: pic_control.o comando.o monitor.o reg_buf.o
	$(XLD) $(LDFLAGS) $(ECOS_GLOBAL_LDFLAGS) -o $@ $@.o monitor.o comando.o reg_buf.o
